...
export default function SocialBox({ icon: Icon, href }: SocialBoxProps) {
  return (
    <Link
      href={href}
    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        <Icon
          className="w-7 h-7 transition-colors duration-500 ease-out text-black group-hover:text-white"
          strokeWidth={2}
        />
      </div>
    </Link>
